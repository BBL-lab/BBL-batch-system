...
conditions(1) = struct( ...
    'names',   {{'A', 'NA', 'R'}}, ...
    'onsets',  {{T{1}(T{1}.CONDITION==1,1), T{1}(T{1}.CONDITION==2,1), T{1}(T{1}.CONDITION==3,1) }}, ...
    'dur', {{[9.6],[9.6],[9.6]}}, ...
...
conditions(2) = struct( ...
    'names',   {{'A', 'NA', 'R'}}, ...
    'onsets',  {{T{2}(T{2}.CONDITION==1,1), T{2}(T{2}.CONDITION==2,1), T{2}(T{2}.CONDITION==3,1) }}, ...
    'dur', {{[9.6],[9.6],[9.6]}}, ...
    'params_per_trialtype', {{[0], [0], [0]}}, ...   
    'parametric_names', {{}}, ...  
    'parametric_values', {{}}, ...  
...
conditions(3) = struct( ...
    'names',   {{'A', 'NA', 'R'}}, ...
    'onsets',  {{T{3}(T{3}.CONDITION==1,1), T{3}(T{3}.CONDITION==2,1), T{3}(T{3}.CONDITION==3,1) }}, ...
    'dur', {{[9.6],[9.6],[9.6]}}, ...
    'params_per_trialtype', {{[0], [0], [0]}}, ...   
    'parametric_names', {{}}, ...  
    'parametric_values', {{}}, ...  
...
conditions(4) = struct( ...
    'names',   {{'A', 'NA', 'R'}}, ...
    'onsets',  {{T{4}(T{4}.CONDITION==1,1), T{4}(T{4}.CONDITION==2,1), T{4}(T{4}.CONDITION==3,1) }}, ...
    'dur', {{[9.6],[9.6],[9.6]}}, ...
    'params_per_trialtype', {{[0], [0], [0]}}, ...   
    'parametric_names', {{}}, ...  
    'parametric_values', {{}}, ...  
...
conditions(5) = struct( ...
    'names',   {{'A', 'NA', 'R'}}, ...
    'onsets',  {{T{5}(T{5}.CONDITION==1,1), T{5}(T{5}.CONDITION==2,1), T{5}(T{5}.CONDITION==3,1) }}, ...
    'dur', {{[9.6],[9.6],[9.6]}}, ...
    'params_per_trialtype', {{[0], [0], [0]}}, ...   
    'parametric_names', {{}}, ...  
    'parametric_values', {{}}, ...  
...
conditions(6) = struct( ...
    'names',   {{'A', 'NA', 'R'}}, ...
    'onsets',  {{T{6}(T{6}.CONDITION==1,1), T{6}(T{6}.CONDITION==2,1), T{6}(T{6}.CONDITION==3,1) }}, ...
    'dur', {{[9.6],[9.6],[9.6]}}, ...
    'params_per_trialtype', {{[0], [0], [0]}}, ...   
    'parametric_names', {{}}, ...  
    'parametric_values', {{}}, ...  
